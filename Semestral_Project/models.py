...
class Classifier:
    ...
    method : str
        ...
        'perceptron', 'cnn2', 'cnn5', 'nn3', and 'nn5'.
    input_dim : int
    ...
    def __init__(self,method,input_dim,num_classes,num_epochs,batch_size=100,lr=1e-3,reg=1e-5,runs_dir=None,seed=10):
        ...
        if method==Method.PERCEPTRON.value:
            self.device = torch.device('cuda:0')
            self.model = Perceptron(input_dim,num_classes=num_classes, device=self.device)
            ...
            raise ValueError("Method must be one of 'perceptron', 'cnn2', 'cnn5', 'nn3', or 'nn5'.")
